...
function Navbar() {
  ...
  return (
  <nav className='w-full fixed z-30 top-0  right-0 left-0 text-black items-center justify-between md:justify-around h-16 flex bg-white shadow-sm shadow-gray-400 '>
