...
function Register() {
  ...
  <div className='w-full   h-screen flex px-2 items-center place-content-center'>
      ...
      <div className={inputcontainer} > 
              <MdEmail /> <input className='outline-none w-full h-12 pl-2 bg-gray-100' name="email" value={values.email} onChange={handlechange} placeholder='enter email' type="email"/>
      </div>
      <div className={inputcontainer} > 
        <FaLock /> <input className='outline-none w-full h-12 pl-2  bg-gray-100' name="password" value={values.password} onChange={handlechange} placeholder='enter password' type="password"/>
      </div>
